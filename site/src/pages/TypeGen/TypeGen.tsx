...
const TypeGen: Component = () => {
    ...
    const codegen = async () => {
         ...
         */
        const url = `/typegen-${lang}-wasm32-wasip1.wasm`;
    ...
    return (
        <>
            <Title>Type Code Generator</Title>
            <div class={styles.TypeGen}>
                <div class={styles.Header}>
                    <h3>
                        Type Code Generator{" "}
                        <a
                            href="https://github.com/zahash/mona/tree/main/typegen"
                            class="link"
                        >
                            GitHub
                        </a>
