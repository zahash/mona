...
export class ValidationResult {
    ...
    constructor(valid, error) {
        var ptr0 = isLikeNone(error) ? 0 : passStringToWasm0(error, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        const ret = wasm.validationresult_new(valid, ptr0, len0);
     ...
     */
    get valid() {
        const ret = wasm.validationresult_valid(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
